...
namespace DACS_Nhom19.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        private async Task<IActionResult> AdminDashboard()
        {
            ...
            // Nhân viên chưa đạt định mức TRONG TUẦN hiện tại
            ...
            // Chart: số ca hoàn thành theo nhân viên trong TUẦN hiện tại
        ...
        private async Task<IActionResult> NhanVienDashboard()
        {
            ...
            // Nếu tài khoản nhân viên chưa gắn với bản ghi nhân viên nào -> hiển thị thông báo
            if (nhanVien == null)
            {
